...
namespace BubblesDivePlanner.Presenters
{
    public class DivePresenter : IDivePresenter
    {
        ...
        {
            isChartDisplay = presenter.GetConfirmationDefaultYes("Use Chart Display?");
        }
        ...
        public List<ICylinder> CreateCylinders(string diveModelName)
        {
            ...
            } while (presenter.GetConfirmationDefaultYes("Create Another Cylinder?"));
        ...
        {
            if (presenter.GetConfirmationDefaultYes("Bubbles Dive Planner Help?"))
            {
