...
namespace BubblesDivePlannerTests.Controllers.Json
{
    public class JsonControllerShould
    {
        ...
        public void Serialise()
        {
            ...
            // Then
            Assert.Equal(EXPECTED_SERIALISED_JSON, actualSerialisedJson);
        }
        ...
        {
            // When
            var actualLastDivePlan = jsonController.Deserialise(EXPECTED_SERIALISED_JSON);
