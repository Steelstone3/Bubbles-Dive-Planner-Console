...
namespace BubblesDivePlannerTests.Presenters
{
    public class DivePresenterShould
    {
        ...
        {
            // Given
            presenter.Setup(p => p.GetConfirmationDefaultYes("Use Chart Display?"));
            divePresenter = new DivePresenter(presenter.Object);
        ...
        {
            // Given
            presenter.Setup(p => p.GetConfirmationDefaultYes("Create Another Cylinder?")).Returns(false);
        ...
        public void CreateCylindersWithoutHeliox()
        {
            ...
            presenter.Verify(p => p.GetConfirmationDefaultYes("Create Another Cylinder?"));
        ...
        {
            // Given
            presenter.Setup(p => p.GetConfirmationDefaultYes("Bubbles Dive Planner Help?")).Returns(true);
