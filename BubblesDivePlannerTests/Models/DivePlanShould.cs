...
namespace BubblesDivePlannerTests.Models
{
    public class DivePlanShould
    {
        ...
        {
            Assert.Null(divePlan.SelectedCylinder);
        }
        ...
        [Fact]
        public void UpdateSelectedCylinder()
        {
            // Given
            var cylinder = new Cylinder(12, 200, new GasMixture(21, 0), 12);
        
            // When
            divePlan.UpdateSelectedCylinder(cylinder);
        
            // Then
            Assert.NotNull(divePlan.SelectedCylinder);
            Assert.Equal(cylinder, divePlan.SelectedCylinder);
        }
        ...
        public void SerialiseUnix()
        {
            ...
            divePlan.UpdateSelectedCylinder(new Cylinder(12, 200, new GasMixture(21, 10), 12));
        ...
        [SkippableFact(Skip="Need to test on a windows machine")]
