...
namespace BubblesDivePlannerTests.Models.DivePlans
{
    public class DivePlanShould
    {
        ...
        {
            expectedCylinders = new List<ICylinder>
            {
                expectedCylinder
            };
            cylinders.Add(cylinder);
            divePlan = new DivePlan(null, diveModel, cylinders, diveStep, cylinder);
        }
        ...
        public void SerialiseRanDivePlanUnix()
        {
            ...
            var divePlanner = new DivePlanner(null, null, null, null);
            var defaultList = CreateDefaultValueList();
            divePlan = new DivePlan(divePlanner, diveModel, expectedCylinders, diveStep, expectedCylinder);
