...
namespace BubblesDivePlannerTests
{
    public static class TestFixture
    {
        ...
        public static double[] ExpectedAValues => new double[COMPARTMENT_COUNT] { 1.2599, 1.0000, 0.8618, 0.7562, 0.6667, 0.5600, 0.4947, 0.4500, 0.4187, 0.3798, 0.3497, 0.3223, 0.2850, 0.2737, 0.2523, 0.2327 };
        ...
        public static double[] ExpectedMaxSurfacePressures => new double[COMPARTMENT_COUNT] { 3.2401, 2.5352, 2.2465, 2.0342, 1.8973, 1.7457, 1.6451, 1.5723, 1.5186, 1.4642, 1.4228, 1.3858, 1.3402, 1.3215, 1.2937, 1.2686 };
        ...
        public static double[] ExpectedToleratedAmbientPressures => new double[COMPARTMENT_COUNT] { 1.4048, 1.3544, 1.1624, 0.9923, 0.8269, 0.7455, 0.6682, 0.6059, 0.5589, 0.5471, 0.5442, 0.5459, 0.5627, 0.5592, 0.5687, 0.5794 };
        public static double[] ExpectedCompartmentLoads => new double[COMPARTMENT_COUNT] { 124.74, 121.46, 110.01, 99.51, 88.77, 82.71, 76.8, 71.87, 68.05, 66.46, 65.62, 65.15, 65.57, 65.05, 65.29, 65.66 };
        public static double ExpectedDepthCeiling => 4.05;
    }
}