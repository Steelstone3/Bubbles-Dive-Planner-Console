...
impl Cylinder {
    pub fn new(
        ...
        Cylinder {
            ...
            gas_mixture,
            gas_management: GasManagement::new(surface_air_consumption_rate),
        }
    }
...
impl Default for Cylinder {
    fn default() -> Self {
        Self {
            cylinder_volume: Default::default(),
            cylinder_pressure: Default::default(),
            initial_pressurised_cylinder_volume: Default::default(),
            gas_mixture: Default::default(),
            gas_management: Default::default(),
        }
    }
}
